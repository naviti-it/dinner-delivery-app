          ...
          {isMenu && (
            <motion.div
              ...
              <ul
                ...
                <li className=' text-base text-textColor hover:text-headingColor hover:bg-slate-100 
              ...
              <p className='m-2 p-2 flex items-center gap-3 cursor-pointer justify-center bg-gray-200 rounded-md shadow-md
