          ...
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                } sm:w-24 w-20 sm:min-w-[94px] sm:h-28 h-24 cursor-pointer rounded-lg drop-shadow-xl flex flex-col ml-3 mt-2 items-center justify-center hover:bg-cartNumBg`}
